...
module.exports = class SupportServerCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['support', 'ss'],
      usage: 'supportserver',
      description: 'Displays the invite link to Universe\'s Discord Support Server.',
  ...
  run(message) {
    const embed = new MessageEmbed()
      ...
      .setDescription('Click [here](https://discord.gg/WM3Se5XGmU) to join the Universe Support Server!')
