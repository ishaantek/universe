...
const art = [
  'https://i.postimg.cc/d1MG7g8r/circle.png',
  'https://i.postimg.cc/nLnkVXtB/universe-server.png'
];
...
module.exports = class GalleryCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['art'],
      usage: 'gallery',
      description: 'Displays a gallery of Universe\'s fan art.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription('All art courtesy of our fans <3')
      .setImage(art[n])
      .setFooter(
