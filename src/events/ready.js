module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`Universe has left ${guild.guild_name}`);
  }

  client.logger.info('Universe is now online');
  client.logger.info(`Universe is running on ${client.guilds.cache.size} server(s)`);
};
