    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      if (modChannelIds.includes(message.channel.id)) {
        if (
          ...
          return; // Return early so Universe doesn't respond
        }
      }
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m Universe. Need help?')
        .setThumbnail('https://i.postimg.cc/d1MG7g8r/circle.png')
        ...
        .addField('Invite Me', oneLine`
          ...
          [here](https://discord.com/api/oauth2/authorize?client_id=937468595032694824&permissions=8&scope=bot)!
        `)
        .addField('Support', oneLine`
          If you have questions, suggestions, or found a bug, please join the 
          [Universe Support Server](https://discord.gg/WM3Se5XGmU)!
        `)
        .setFooter('DM All About Ishaan#5499 to speak directly with the developer!')
